...
[
	...
	["Combat Helmet (Woodland)", "H_HelmetB_plain_wdl", 50, "hat"],
	...
	["Stealth Combat Helmet (Arid)", "H_HelmetB_TI_arid_F", 75, "hat"],
	...
	["Enhanced Combat Helmet (Woodland)", "H_HelmetSpecB_wdl", 75, "hat"],
	...
	["Assassin Helmet (Green Hex)", "H_HelmetSpecO_ghex_F", 75, "hat"],
	...
	["Pilot Helmet (LDF)", "H_PilotHelmetFighter_I_E", 60, "hat"],
	["Crew Helmet (NATO)", "H_HelmetCrew_B", 60, "hat"],
	["Crew Helmet (CSAT)", "H_HelmetCrew_O", 60, "hat"],
	["Crew Helmet (Green Hex)(CSAT)", "H_HelmetCrew_O_ghex_F", 60, "hat"],
	["Crew Helmet (AAF)", "H_HelmetCrew_I", 60, "hat"],
	["Crew Helmet (LDF)", "H_HelmetCrew_I_E", 60, "hat"],
	["Crew Helmet (SOFT)[LDF]", "H_Tank_eaf_F", 60, "hat"],
	...
	["Heli Pilot Helmet (LDF)", "H_PilotHelmetHeli_I_E", 50, "hat"],
	...
	["Heli Crew Helmet (LDF)", "H_CrewHelmetHeli_I_E", 50, "hat"],
	["Basic Helmet (Black)", "H_PASGT_basic_black_F", 50, "hat"],
	["Basic Helmet (Blue)", "H_PASGT_basic_blue_F", 50, "hat"],
	["Basic Helmet (Olive)", "H_PASGT_basic_olive_F", 50, "hat"],
	["Basic Helmet (White)", "H_PASGT_basic_white_F", 50, "hat"],
	["Press Helmet", "H_PASGT_basic_blue_press_F", 50, "hat"],
	["Press Helmet (Neck Protection)", "H_PASGT_neckprot_blue_press_F", 50, "hat"],
	...
	["Parade Cap (AAF)", "H_ParadeDressCap_01_AAF_F", 75, "hat"],
	["Parade Cap (CSAT)", "H_ParadeDressCap_01_CSAT_F", 75, "hat"],
	["Parade Cap (LDF)", "H_ParadeDressCap_01_LDF_F", 75, "hat"],
	["Parade Cap (US)", "H_ParadeDressCap_01_US_F", 75, "hat"],
...
[
	...
	["Gendarmerie Commander Uniform", "U_B_GEN_Commander_F", 200, "uni"],
	["Gendarmerie Uniform", "U_B_GEN_Soldier_F", 200, "uni"],
	//["Gendarmerie Commander Uniform", "U_O_GEN_Commander_F", 200, "uni"],
	//["Gendarmerie Uniform", "U_O_GEN_Soldier_F", 200, "uni"],

	["Light Ghillie", "U_B_GhillieSuit", 750, "uni"],
	["Light Ghillie", "U_O_GhillieSuit", 750, "uni"],
	["Light Ghillie", "U_I_GhillieSuit", 750, "uni"],
	["Light Ghillie (Jungle)", "U_B_T_Sniper_F", 750, "uni"],
	["Light Ghillie (Jungle)", "U_O_T_Sniper_F", 750, "uni"],
	...
	["Formal Suit (Black)", "U_C_FormalSuit_01_black_F", 200, "uni", "noDLC"],
	["Formal Suit (Blue)", "U_C_FormalSuit_01_blue_F", 200, "uni", "noDLC"],
	["Formal Suit (Grey)", "U_C_FormalSuit_01_grey_F", 200, "uni", "noDLC"],
	["Formal Suit (Khaki)", "U_C_FormalSuit_01_khaki_F", 200, "uni", "noDLC"],
	["Formal Suit (T-Shirt, Black)", "U_C_FormalSuit_01_tshirt_black_F",150, "uni", "noDLC"],
	["Formal Suit (T-Shirt, Grey)", "U_C_FormalSuit_01_tshirt_grey_F", 150, "uni", "noDLC"],
	...
	["Combat Fatigues (Woodland)", "U_B_CombatUniform_mcam_wdl_f", 250, "uni"],
	["Combat Fatigues (Woodland)", "U_B_CombatUniform_mcam_wdl_f", 250, "uni"],
	["Combat Fatigues (Woodland, Tee)", "U_B_CombatUniform_tshirt_mcam_wdL_f", 250, "uni"],
	...
	["CTRG Stealth Uniform (Rolled-up)", "U_B_CTRG_Soldier_3_F", 250, "uni"],
	["CTRG Stealth Uniform (Tee)", "U_B_CTRG_Soldier_2_F", 250, "uni"],
	["CTRG Stealth Uniform (Arid)", "U_B_CTRG_Soldier_Arid_F", 250, "uni"],
	["CTRG Stealth Uniform (Tee, Arid)", "U_B_CTRG_Soldier_2_Arid_F", 250, "uni"],
	["CTRG Stealth Uniform (Rolled-up, Arid)", "U_B_CTRG_Soldier_3_Arid_F", 250, "uni"],
	["CTRG Urban Uniform", "U_B_CTRG_Soldier_urb_1_F", 250, "uni"],
	["CTRG Urban Uniform (Tee)", "U_B_CTRG_Soldier_urb_2_F", 250, "uni"],
	["CTRG Urban Uniform (Rolled-up)", "U_B_CTRG_Soldier_urb_3_F", 250, "uni"],
	...
	["Officer Fatigues (Green Hex) [CSAT]", "U_O_T_Officer_F", 250, "uni"],
	...
	["Guerilla Garment (Olive)", "U_BG_Guerilla1_2_F", 50, "uni"], // Independent
...
[
	...
	["Multi-Pocket Vest (Olive)", "V_Pocketed_olive_F", -1, "vest"],
	["Multi-Pocket Vest (Coyote)", "V_Pocketed_coyote_F", -1, "vest"],
	["Multi-Pocket Vest (Black)", "V_Pocketed_black_F", -1, "vest"],
...
[
	...
	/*["Assault Pack (Coyote)", "B_AssaultPack_tna_F", 100, "backpack"],
	["Assault Pack (Digital)", "B_AssaultPack_tna_F", 100, "backpack"],
	["Assault Pack (Geometric)", "B_AssaultPack_tna_F", 100, "backpack", "noDLC"],
	["Assault Pack (Hex)", "B_AssaultPack_ocamo", 100, "backpack"],
	["Assault Pack (Khaki)", "B_AssaultPack_tna_F", 100, "backpack"],*/
	["Assault Pack (Green)", "B_AssaultPack_rgr", 100, "backpack"],
	["Assault Pack (MTP)", "B_AssaultPack_mcamo", 100, "backpack"],
	//["Assault Pack (Sage)", "B_AssaultPack_tna_F", 100, "backpack"],
	["Assault Pack (Tropic)", "B_AssaultPack_tna_F", 100, "backpack", "noDLC"],
	//["Assault Pack (Woodland)", "B_AssaultPack_tna_F", 100, "backpack", "noDLC"],
	...
	["Sport Backpack (Red)", "B_CivilianBackpack_01_Sport_Blue_F", 275, "backpack", "noDLC"],
...
[
	...
	["Respirator (While)", "G_Respirator_white_F", 25, "gogg"],
	...
	["Safety Goggles", "G_EyeProtectors_F", 10, "gogg"],
	["Safety Goggles (Earpiece)", "G_EyeProtectors_Earpiece_F", 10, "gogg"],
