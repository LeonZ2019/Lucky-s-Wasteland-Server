...
[
	...
	["Promet Rifle", "arifle_MSBS65_F", 200, "noDLC"],
	["Promet Rifle (Black)", "arifle_MSBS65_black_F", 200, "noDLC"],
	["Promet Rifle (Camo)", "arifle_MSBS65_camo_F", 200, "noDLC"],
	["Promet Rifle (Sand)", "arifle_MSBS65_sand_F", 200, "noDLC"],
	["Promet GL Rifle", "arifle_MSBS65_GL_F", 250, "noDLC"],
	["Promet GL Rifle (Black)", "arifle_MSBS65_GL_black_F", 250, "noDLC"],
	["Promet GL Rifle (Camo)", "arifle_MSBS65_GL_camo_F", 250, "noDLC"],
	["Promet GL Rifle (Sand)", "arifle_MSBS65_GL_sand_F", 250, "noDLC"],
	["Promet SG Rifle", "arifle_MSBS65_UBS_F", 250, "noDLC"],
	["Promet SG Rifle (Black)", "arifle_MSBS65_UBS_black_F", 250, "noDLC"],
	["Promet SG Rifle (Camo)", "arifle_MSBS65_UBS_camo_F", 250, "noDLC"],
	["Promet SG Rifle (Sand)", "arifle_MSBS65_UBS_sand_F", 250, "noDLC"]
];

sniperArray = compileFinal str
[
	["Mk14 Rifle (Camo)", "srifle_DMR_06_camo_F", 400, "noDLC"],
	["Mk14 Rifle (Olive)", "srifle_DMR_06_olive_F", 400, "noDLC"],
	["Mk14 Rifle (Classic)", "srifle_DMR_06_hunter_F", 400, "noDLC"],
	...
	["Promet MR Rifle", "arifle_MSBS65_Mark_F", 300, "noDLC"],
	["Promet MR Rifle (Black)", "arifle_MSBS65_Mark_black_F", 300, "noDLC"],
	["Promet MR Rifle (Camo)", "arifle_MSBS65_Mark_camo_F", 300, "noDLC"],
	["Promet MR Rifle (Sand)", "arifle_MSBS65_Mark_sand_F", 300, "noDLC"],
	...
	["ASP-1 Kir Rifle", "srifle_DMR_04_F", 750],
	["ASP-1 Kir Rifle (Tan)", "srifle_DMR_04_tan_F", 750],
...
[
	...
	["Titan MPRL AA (Geometric)", "launch_I_Titan_eaf_F", 1500, "noDLC"]
];
...
[
	...
	["M2 HMG .50", "B_G_HMG_02_F", 3000],
	["M2 HMG .50", "O_G_HMG_02_F", 3000],
	["M2 HMG .50", "I_G_HMG_02_F", 3000],
	["M2 HMG .50 (Raised)", "B_G_HMG_02_high_F", 3000],
	["M2 HMG .50 (Raised)", "O_G_HMG_02_high_F", 3000],
	["M2 HMG .50 (Raised)", "I_G_HMG_02_high_F", 3000],
	["Mk30 HMG .50 Low tripod", "B_HMG_01_F", 2000],
	["Mk30 HMG .50 Low tripod", "O_HMG_01_F", 2000],
	["Mk30 HMG .50 Low tripod", "I_HMG_01_F", 2000],
	["Mk30A HMG .50 Sentry", "B_HMG_01_A_F", 5000],
...
[
	...
	["Signal Flares (Green)", "6Rnd_GreenSignal_F", 5],
	["Signal Flares (Red)", "6Rnd_RedSignal_F", 5],
...
[
	...
	["Advanced Modular Helmet", "H_HelmetHBK_headset_F", 50, "hat", "noDLC"],
	["Advanced Modular Helmet (Olive)", "H_HelmetHBK_F", 50, "hat", "noDLC"],
	["Advanced Modular Helmet (Chops)", "H_HelmetHBK_chops_F", 75, "hat", "noDLC"],
	["Advanced Modular Helmet (Ear Protectors)", "H_HelmetHBK_ear_F", 75, "hat", "noDLC"],
	["Light Combat Helmet", "H_HelmetB_light", 40, "hat"],
	["Light Combat Helmet (Grass)", "H_HelmetB_light_grass", 40, "hat"],
	["Light Combat Helmet (Snakeskin)", "H_HelmetB_light_snakeskin", 40, "hat"],
	["Light Combat Helmet (Desert)", "H_HelmetB_light_desert", 40, "hat"],
	["Light Combat Helmet (Black)", "H_HelmetB_light_black", 40, "hat"],
	["Light Combat Helmet (Sand)", "H_HelmetB_light_sand", 40, "hat"],
	["Light Combat Helmet (Tropic)", "H_HelmetB_Light_tna_F", 40, "hat", "noDLC"],
	["Light Combat Helmet (Woodland)", "H_HelmetB_light_wdl", 40, "hat", "noDLC"],
	...
	["Combat Helmet (Tropic)", "H_HelmetB_tna_F", 50, "hat", "noDLC"],
	["Combat Helmet (Woodland)", "H_HelmetB_plain_wdl", 50, "hat", "noDLC"],
	["Stealth Combat Helmet", "H_HelmetB_TI_tna_F", 75, "hat", "noDLC"],
	["Stealth Combat Helmet (Arid)", "H_HelmetB_TI_arid_F", 75, "hat", "noDLC"],
	...
	["Enhanced Combat Helmet (Woodland)", "H_HelmetSpecB_wdl", 75, "hat", "noDLC"],
	["Enhanced Combat Helmet (Tropic)", "H_HelmetB_Enh_tna_F", 75, "hat", "noDLC"],
	["Protector Helmet (Hex)", "H_HelmetO_ocamo", 60, "hat"],
	["Protector Helmet (Green Hex)", "H_HelmetO_ghex_F", 60, "hat", "noDLC"],
	...
	["Assassin Helmet (Black)", "H_HelmetSpecO_blk", 75, "hat", "noDLC"],
	["Avenger Helmet", "H_HelmetAggressor_F", 75, "hat", "noDLC"],
	["Avenger Helmet (Cover B)", "H_HelmetAggressor_cover_F", 75, "hat", "noDLC"],
	["Avenger Helmet (Cover T)", "H_HelmetAggressor_cover_taiga_F", 75, "hat", "noDLC"],
	...
	["Pilot Helmet (LDF)", "H_PilotHelmetFighter_I_E", 60, "hat", "noDLC"],
	["Crew Helmet (NATO)", "H_HelmetCrew_B", 60, "hat"],
	["Crew Helmet (CSAT)", "H_HelmetCrew_O", 60, "hat"],
	["Crew Helmet (Green Hex)(CSAT)", "H_HelmetCrew_O_ghex_F", 60, "hat", "noDLC"],
	["Crew Helmet (AAF)", "H_HelmetCrew_I", 60, "hat"],
	["Crew Helmet (LDF)", "H_HelmetCrew_I_E", 60, "hat", "noDLC"],
	["Crew Helmet (SOFT)[LDF]", "H_Tank_eaf_F", 60, "hat", "noDLC"],
	...
	["Heli Pilot Helmet (LDF)", "H_PilotHelmetHeli_I_E", 50, "hat", "noDLC"],
	...
	["Heli Crew Helmet (LDF)", "H_CrewHelmetHeli_I_E", 50, "hat", "noDLC"],
	["Basic Helmet (Black)", "H_PASGT_basic_black_F", 50, "hat", "noDLC"],
	["Basic Helmet (Blue)", "H_PASGT_basic_blue_F", 50, "hat", "noDLC"],
	["Basic Helmet (Olive)", "H_PASGT_basic_olive_F", 50, "hat", "noDLC"],
	["Basic Helmet (White)", "H_PASGT_basic_white_F", 50, "hat", "noDLC"],
	["Press Helmet", "H_PASGT_basic_blue_press_F", 50, "hat", "noDLC"],
	["Press Helmet (Neck Protection)", "H_PASGT_neckprot_blue_press_F", 50, "hat", "noDLC"],
	["Safari Hat (Sand)", "H_Hat_Safari_sand_F", 10, "hat", "noDLC"],
	["Safari Hat (Olive)", "H_Hat_Safari_olive_F", 10, "hat", "noDLC"],
	...
	["Beret [LDF]", "H_Beret_EAF_01_F", 10, "hat", "noDLC"],
	["Beret (Red) [CSAT]", "H_Beret_CSAT_01_F", 10, "hat", "noDLC"],
	["Beret (Gendarmerie)", "H_Beret_gen_F", 10, "hat", "noDLC"],
	...
	["Booniehat (Tropic)", "H_Booniehat_tna_F", 10, "hat", "noDLC"],
	["Booniehat (Green)", "H_Booniehat_mgrn", 10, "hat", "noDLC"],
	["Booniehat (Taiga)", "H_Booniehat_taiga", 10, "hat", "noDLC"],
	["Booniehat [LDF]", "H_Booniehat_eaf", 10, "hat", "noDLC"],
	["Booniehat (Woodland)", "H_Booniehat_wdl", 10, "hat", "noDLC"],
	...
	["Parade Cap (AAF)", "H_ParadeDressCap_01_AAF_F", 75, "hat", "noDLC"],
	["Parade Cap (CSAT)", "H_ParadeDressCap_01_CSAT_F", 75, "hat", "noDLC"],
	["Parade Cap (LDF)", "H_ParadeDressCap_01_LDF_F", 75, "hat", "noDLC"],
	["Parade Cap (US)", "H_ParadeDressCap_01_US_F", 75, "hat", "noDLC"],
	...
	["Cap (White) [IDAP]", "H_Cap_White_IDAP_F", 10, "hat", "noDLC"],
	["Cap (Orange) [IDAP]", "H_Cap_Orange_IDAP_F", 10, "hat", "noDLC"],
	["Cap (Black) [IDAP]", "H_Cap_Black_IDAP_F", 10, "hat", "noDLC"],
	...
	["Military Cap (Tropic)", "H_MilCap_tna_F", 25, "hat", "noDLC"],
	["Military Cap (Green Hex)", "H_MilCap_ghex_F", 25, "hat", "noDLC"],
	["Military Cap (Gendarmerie)", "H_MilCap_gen_F", 25, "hat", "noDLC"],
	...
	["Hard Hat (Yellow)", "H_Construction_basic_yellow_F", 15, "hat", "noDLC"],
	["Hard Hat (White)", "H_Construction_basic_white_F", 15, "hat", "noDLC"],
	["Hard Hat (Orange)", "H_Construction_basic_orange_F", 15, "hat", "noDLC"],
	["Hard Hat (Red)", "H_Construction_basic_red_F", 15, "hat", "noDLC"],
	["Hard Hat (Vrana)", "H_Construction_basic_vrana_F", 15, "hat", "noDLC"],
	["Hard Hat (Black)", "H_Construction_basic_black_F", 15, "hat", "noDLC"],
	["Hard Hat (Yellow, Ear Protectors)", "H_Construction_earprot_yellow_F", 15, "hat", "noDLC"],
	["Hard Hat (White, Ear Protectors)", "H_Construction_earprot_white_F", 15, "hat", "noDLC"],
	["Hard Hat (Orange, Ear Protectors)", "H_Construction_earprot_orange_F", 15, "hat", "noDLC"],
	["Hard Hat (Red, Ear Protectors)", "H_Construction_earprot_red_F", 15, "hat", "noDLC"],
	["Hard Hat (Vrana, Ear Protectors)", "H_Construction_earprot_vrana_F", 15, "hat", "noDLC"],
	["Hard Hat (Black, Ear Protectors)", "H_Construction_earprot_black_F", 15, "hat", "noDLC"],
	["Hard Hat (Yellow, Headset)", "H_Construction_headset_yellow_F", 15, "hat", "noDLC"],
	["Hard Hat (White, Headset)", "H_Construction_headset_white_F", 15, "hat", "noDLC"],
	["Hard Hat (Orange, Headset)", "H_Construction_headset_orange_F", 15, "hat", "noDLC"],
	["Hard Hat (Red, Headset)", "H_Construction_headset_red_F", 15, "hat", "noDLC"],
	["Hard Hat (Vrana, Headset)", "H_Construction_headset_vrana_F", 15, "hat", "noDLC"],
	["Hard Hat (Black, Headset)", "H_Construction_headset_black_F", 15, "hat", "noDLC"],
	["Tin Foil Hat", "H_Hat_Tinfoil_F", 666, "hat", "noDLC"],
	["Skate Helmet", "H_Helmet_Skate", 10, "hat", "noDLC"]
];

uniformArray = compileFinal str
[
	["Wetsuit", "U_B_Wetsuit", 350, "uni"],
	["Wetsuit", "U_O_Wetsuit", 350, "uni"],
	["Wetsuit", "U_I_Wetsuit", 350, "uni"],
	...
	["Light Ghillie", "U_B_GhillieSuit", 750, "uni"],
	["Light Ghillie", "U_O_GhillieSuit", 750, "uni"],
	["Light Ghillie", "U_I_GhillieSuit", 750, "uni"],
	["Light Ghillie (Jungle)", "U_B_T_Sniper_F", 750, "uni", "noDLC"],
	["Light Ghillie (Jungle)", "U_O_T_Sniper_F", 750, "uni", "noDLC"],
	["Full Ghillie (Arid)", "U_B_FullGhillie_ard", 2000, "uni", "noDLC"],
	["Full Ghillie (Arid)", "U_O_FullGhillie_ard", 2000, "uni", "noDLC"],
	["Full Ghillie (Arid)", "U_I_FullGhillie_ard", 2000, "uni", "noDLC"],
	["Full Ghillie (Lush)", "U_B_FullGhillie_lsh", 2000, "uni", "noDLC"],
	["Full Ghillie (Lush)", "U_O_FullGhillie_lsh", 2000, "uni", "noDLC"],
	["Full Ghillie (Lush)", "U_I_FullGhillie_lsh", 2000, "uni", "noDLC"],
	["Full Ghillie (Semi-Arid)", "U_B_FullGhillie_sard", 2000, "uni", "noDLC"],
	["Full Ghillie (Semi-Arid)", "U_O_FullGhillie_sard", 2000, "uni", "noDLC"],
	["Full Ghillie (Semi-Arid)", "U_I_FullGhillie_sard", 2000, "uni", "noDLC"],
	["Full Ghillie (Jungle)", "U_B_T_FullGhillie_tna_F", 2000, "uni", "noDLC"],
	["Full Ghillie (Jungle)", "U_O_T_FullGhillie_tna_F", 2000, "uni", "noDLC"],
	["Special Purpose Suit (Hex)", "U_O_V_Soldier_Viper_hex_F", 1000, "uni", "noDLC"],
	["Special Purpose Suit (G Hex)", "U_O_V_Soldier_Viper_F", 1000, "uni", "noDLC"],
	["Survival Fatigues (NATO)", "U_B_survival_uniform", 200, "uni"],
	["CBRN Suit (AAF)", "U_I_CBRN_Suit_01_AAF_F", 200, "uni", "noDLC"],
	["CBRN Suit (Blue)", "U_C_CBRN_Suit_01_Blue_F", 200, "uni", "noDLC"],
	["CBRN Suit (LDF)", "U_I_E_CBRN_Suit_01_EAF_F", 200, "uni", "noDLC"],
	["CBRN Suit (MTP)", "U_B_CBRN_Suit_01_MTP_F", 200, "uni", "noDLC"],
	["CBRN Suit (Tropic)", "U_B_CBRN_Suit_01_Tropic_F", 200, "uni", "noDLC"],
	["CBRN Suit (White)", "U_C_CBRN_Suit_01_White_F", 200, "uni", "noDLC"],
	["CBRN Suit (Woodland)", "U_B_CBRN_Suit_01_Wdl_F", 200, "uni", "noDLC"],
	["Granit-B Suit", "U_O_R_Gorka_01_F", 200, "uni", "noDLC"],
	["Granit-B Suit (Weathered)", "U_O_R_Gorka_01_brown_F", 200, "uni", "noDLC"],
	["Granit-T Suit", "U_O_R_Gorka_01_camo_F", 200, "uni", "noDLC"],
	["Granit-N Suit", "U_O_R_Gorka_01_black_F", 200, "uni", "noDLC"],
	...
	["Recon Fatigues (Tropic)", "U_B_T_Soldier_SL_F", 250, "uni", "noDLC"],
	["Recon Fatigues (Woodland)", "U_B_CombatUniform_vest_mcam_wdl_f", 250, "uni", "noDLC"],
	["Recon Fatigues (Hex)", "U_O_SpecopsUniform_ocamo", 250, "uni"],
	["Combat Fatigues (Tropic)", "U_B_T_Soldier_F", 250, "uni", "noDLC"],
	["Combat Fatigues [LDF]", "U_I_E_Uniform_01_F", 250, "uni", "noDLC"],
	["Combat Fatigues (Officer)[LDF]", "U_I_E_Uniform_01_officer_F", 250, "uni", "noDLC"],
	["Combat Fatigues (Rolled-up)[LDF]", "U_I_E_Uniform_01_shortsleeve_F", 250, "uni", "noDLC"],
	["Combat Fatigues (Sweater)[LDF]", "U_I_E_Uniform_01_sweater_F", 250, "uni", "noDLC"],
	["Combat Fatigues (Tank Top)[LDF]", "U_I_E_Uniform_01_tanktop_F", 250, "uni", "noDLC"],
	["Combat Fatigues (Tee)", "U_B_CombatUniform_mcam_tshirt", 250, "uni"],
	["Combat Fatigues (Tropic, Tee)", "U_B_T_Soldier_AR_F", 250, "uni", "noDLC"],
	["Combat Fatigues (Gangsta)", "U_I_G_resistanceLeader_F", 250, "uni"],
	["Combat Fatigues (Rolled-up)", "U_I_CombatUniform_shortsleeve", 250, "uni"],
	["Combat Fatigues (Woodland)", "U_B_CombatUniform_mcam_wdl_f", 250, "uni", "noDLC"],
	["Combat Fatigues (Woodland)", "U_B_CombatUniform_mcam_wdl_f", 250, "uni", "noDLC"],
	["Combat Fatigues (Woodland, Tee)", "U_B_CombatUniform_tshirt_mcam_wdL_f", 250, "uni", "noDLC"],
	["CTRG Combat Uniform", "U_B_CTRG_1", 250, "uni", "noDLC"],
	["CTRG Combat Uniform (Tee)", "U_B_CTRG_2", 250, "uni", "noDLC"],
	["CTRG Combat Uniform (Rolled-up)", "U_B_CTRG_3", 250, "uni", "noDLC"],
	["CTRG Stealth Uniform", "U_B_CTRG_Soldier_F", 1000, "uni", "noDLC"],
	["CTRG Stealth Uniform (Rolled-up)", "U_B_CTRG_Soldier_3_F", 250, "uni", "noDLC"],
	["CTRG Stealth Uniform (Tee)", "U_B_CTRG_Soldier_2_F", 250, "uni", "noDLC"],
	["CTRG Stealth Uniform (Arid)", "U_B_CTRG_Soldier_Arid_F", 250, "uni", "noDLC"],
	["CTRG Stealth Uniform (Tee, Arid)", "U_B_CTRG_Soldier_2_Arid_F", 250, "uni", "noDLC"],
	["CTRG Stealth Uniform (Rolled-up, Arid)", "U_B_CTRG_Soldier_3_Arid_F", 250, "uni", "noDLC"],
	["CTRG Urban Uniform", "U_B_CTRG_Soldier_urb_1_F", 250, "uni", "noDLC"],
	["CTRG Urban Uniform (Tee)", "U_B_CTRG_Soldier_urb_2_F", 250, "uni", "noDLC"],
	["CTRG Urban Uniform (Rolled-up)", "U_B_CTRG_Soldier_urb_3_F", 250, "uni", "noDLC"],
	["Fatigues (Hex)", "U_O_CombatUniform_ocamo", 400, "uni"],
	["Fatigues (Urban)", "U_O_CombatUniform_oucamo", 400, "uni"],
	["Fatigues (G Hex)", "U_O_T_Soldier_F", 400, "uni", "noDLC"],
	["Officer Fatigues", "U_I_OfficerUniform", 250, "uni"],
	["Officer Fatigues (Green Hex) [CSAT]", "U_O_T_Officer_F", 250, "uni", "noDLC"],
	["Officer Fatigues (Hex)", "U_O_OfficerUniform_ocamo", 250, "uni"],
	...
	["Heli Pilot Coveralls [NATO]", "U_B_HeliPilotCoveralls", 300, "uni"],
	["Heli Pilot Coveralls [AAF]", "U_I_HeliPilotCoveralls", 300, "uni"],
	["Heli Pilot Coveralls {LDF}", "U_I_E_Uniform_01_coveralls_F", 300, "uni"],
	...
	["Guerilla Garment (Olive)", "U_BG_Guerilla1_2_F", 50, "uni", "noDLC"], // Independent
	...
	["Marshal Clothes", "U_Marshal", 50, "uni"],
	...
	["Tron Light Suit [Civilians]", "U_C_Protagonist_VR", 5000, "uni"],
	...
	["Formal Suit (Blue)", "U_C_FormalSuit_01_blue_F", 1000, "uni", "noDLC"],
	["Formal Suit (Gray)", "U_C_FormalSuit_01_gray_F", 1000, "uni", "noDLC"],
...
[
	...
	["Assault Pack (Digital)", "B_AssaultPack_dgtl", 100, "backpack"],
	["Assault Pack (Geometric)", "B_AssaultPack_eaf_F", 100, "backpack", "noDLC"],
	["Assault Pack (Hex)", "B_AssaultPack_ocamo", 100, "backpack"],
	["Assault Pack (Khaki)", "B_AssaultPack_khk", 100, "backpack"],
	["Assault Pack (Green)", "B_AssaultPack_rgr", 100, "backpack"],
	["Assault Pack (MTP)", "B_AssaultPack_mcamo", 100, "backpack"],
	["Assault Pack (Sage)", "B_AssaultPack_sgg", 100, "backpack"],
	["Assault Pack (Tropic)", "B_AssaultPack_tna_F", 100, "backpack", "noDLC"],
	["Assault Pack (Woodland)", "B_AssaultPack_wdl_F", 100, "backpack", "noDLC"],
	...
	["Field Pack (Green)", "B_FieldPack_green_F", 200, "backpack", "noDLC"],
	...
	["Field Pack (Taiga)", "B_FieldPack_taiga_F", 200, "backpack", "noDLC"],
	...
	["Kitbag (Tan)", "B_Kitbag_tan", 350, "backpack"],
	...
	["Carryall Backpack (Coyote)", "B_Carryall_cbr", 500, "backpack"],
	["Carryall (Olive)", "B_Carryall_oli", 500, "backpack"],
	["Carryall (Urban)", "B_Carryall_oucamo", 500, "backpack"],
	["Carryall Backpack (Hex)", "B_Carryall_ocamo", 500, "backpack"],
	...
	["Tactical Backpack (Green)", "B_TacticalPack_rgr", 300, "backpack"],
	["Tactical Backpack (Black)", "B_TacticalPack_blk", 300, "backpack"],
	["Tactical Backpack (Hex)", "B_TacticalPack_ocamo", 300, "backpack", "noDLC"],
	["Tactical Backpack (MTP)", "B_TacticalPack_mcamo", 300, "backpack", "noDLC"],
	["Tactical Backpack (Olive)", "B_TacticalPack_oli", 300, "backpack", "noDLC"],

	["Everyday Backpack (Astra)", "B_CivilianBackpack_01_Everyday_Astra_F", 250, "backpack", "noDLC"],
	["Everyday Backpack (Black)", "B_CivilianBackpack_01_Everyday_Black_F", 250, "backpack", "noDLC"],
	["Everyday Backpack (Vrana)", "B_CivilianBackpack_01_Everyday_Vrana_F", 250, "backpack", "noDLC"],
	["Everyday Backpack (IDAP)", "B_CivilianBackpack_01_Everyday_IDAP_F", 250, "backpack", "noDLC"],

	["Sport Backpack (Blue)", "B_CivilianBackpack_01_Sport_Blue_F", 275, "backpack", "noDLC"],
	["Sport Backpack (Green)", "B_CivilianBackpack_01_Sport_Green_F", 275, "backpack", "noDLC"],
	["Sport Backpack (Red)", "B_CivilianBackpack_01_Sport_Red_F", 275, "backpack", "noDLC"],
	...
	["Messenger Bag (Black)", "B_Messenger_Black_F", 75, "backpack", "noDLC"],
	["Messenger Bag (Coyote)", "B_Messenger_Coyote_F", 75, "backpack", "noDLC"],
	["Messenger Bag (Grey)", "B_Messenger_Gray_F", 75, "backpack", "noDLC"],
	["Messenger Bag (Olive)", "B_Messenger_Olive_F", 75, "backpack", "noDLC"],
	["Messenger Bag (IDAP)", "B_Messenger_IDAP_F", 75, "backpack", "noDLC"],

	["Leg Strap Bag (Black)", "B_LegStrapBag_black_F", 65, "backpack", "noDLC"],
	["Leg Strap Bag (Coyote)", "B_LegStrapBag_coyote_F", 65, "backpack", "noDLC"],
	...
	["Radio Pack (MTP)[NATO]", "B_RadioBag_01_mtp_F", 50, "backpack", "noDLC"],
	["Radio Pack (Tropic)[NATO]", "B_RadioBag_01_tropic_F", 50, "backpack", "noDLC"],
	["Radio Pack (Urban)[CSAT]", "B_RadioBag_01_oucamo_F", 50, "backpack", "noDLC"],
	["Radio Pack (Woodland)[NATO]", "B_RadioBag_01_wdl_F", 50, "backpack", "noDLC"],
	["Combination Unit Respirator", "B_CombinationUnitRespirator_01_F", 40, "backpack", "noDLC"],
	["Self-Contained Breathing Apparatus", "B_SCBA_01_F", 40, "backpack", "noDLC"]
];
...
[
	...
	["AR-2 Darter UAV", "I_E_UAV_01_backpack_F", 2500, "backpack", "noDLC"],
	["AL-6 Pelican UAV", "B_UAV_06_backpack_F", 250, "backpack", "noDLC"],
	["AL-6 Pelican UAV", "O_UAV_06_backpack_F", 250, "backpack", "noDLC"],
	["AL-6 Pelican UAV", "I_UAV_06_backpack_F", 250, "backpack", "noDLC"],
	["AL-6 Pelican UAV", "I_E_UAV_06_backpack_F", 250, "backpack", "noDLC"],
	["AL-6 Pelican Medical UAV", "B_UAV_06_medical_backpack_F", 1000, "backpack", "noDLC"],
	["AL-6 Pelican Medical UAV", "O_UAV_06_medical_backpack_F", 1000, "backpack", "noDLC"],
	["AL-6 Pelican Medical UAV", "I_UAV_06_medical_backpack_F", 1000, "backpack", "noDLC"],
	["AL-6 Pelican Medical UAV", "I_E_UAV_06_medical_backpack_F", 1000, "backpack", "noDLC"],
	["AL-6 Pelican Demining UAV", "C_IDAP_UAV_06_antimine_backpack_F", 5000, "backpack", "noDLC"],
	["ED-1E Camera UGV", "B_UGV_02_Science_backpack_F", 1000, "backpack", "noDLC"],
	["ED-1E Camera UGV", "O_UGV_02_Science_backpack_F", 1000, "backpack", "noDLC"],
	["ED-1E Camera UGV", "I_UGV_02_Science_backpack_F", 1000, "backpack", "noDLC"],
	["ED-1E Camera UGV", "I_E_UGV_02_Science_backpack_F", 1000, "backpack", "noDLC"],
	...
	["ED-1D Demining UGV", "I_E_UGV_02_Demining_backpack_F", 5000, "backpack", "noDLC"],
	["Remote Designator (Khaki)", "B_W_Static_Designator_01_weapon_F", 750, "backpack", "noDLC"],
	["Remote Designator (Sand)", "B_Static_Designator_01_weapon_F", 750, "backpack", "noDLC"],
	["Remote Designator (Hex)", "O_Static_Designator_02_weapon_F", 750, "backpack", "noDLC"],
	["GPS", "ItemGPS", 100, "gps"],
	...
	["Regulator Facepiece", "G_RegulatorMask_F", 25, "gogg", "noDLC"],
	["APR Gasmask (NATO/Black)", "G_AirPurifyingRespirator_01_F", 25, "gogg", "noDLC"],
	["APR Gasmask (CSAT/Black)", "G_AirPurifyingRespirator_02_black_F", 25, "gogg", "noDLC"],
	["APR Gasmask (CSAT/Olive)", "G_AirPurifyingRespirator_02_olive_F", 25, "gogg", "noDLC"],
	["APR Gasmask (CSAT/Sand)", "G_AirPurifyingRespirator_02_sand_F", 25, "gogg", "noDLC"],
	...
	["Wireless Earpiece", "G_WirelessEarpiece_F", 25, "gogg", "noDLC"],
...
[
	...
	["ED-1E Camera UGV", "I_E_UGV_02_Science_F", GENSTORE_ITEM_PRICE("I_E_UGV_02_Science_backpack_F"), "vehicle", "SKIPSAVE"],
	...
	["ED-1D Demining UGV", "I_E_UGV_02_Demining_F", GENSTORE_ITEM_PRICE("I_E_UGV_02_Demining_backpack_F"), "vehicle", "SKIPSAVE"],
	...
	["2S9 Sochor", "O_MBT_02_arty_F", 100000, "vehicle"],
	["M4 Scorcher", "B_MBT_01_arty_F", 100000, "vehicle"]
];
...
[
	...
	["AR-2 Darter UAV", "I_E_UAV_01_F", GENSTORE_ITEM_PRICE("I_E_UAV_01_backpack_F"), "vehicle", "SKIPSAVE"],
	...
	["AL-6 Pelican UAV", "I_E_UAV_06_F", GENSTORE_ITEM_PRICE("I_E_UAV_06_backpack_F"), "vehicle", "SKIPSAVE"],
	...
	["AL-6 Pelican Medical UAV", "I_E_UAV_06_medical_F", GENSTORE_ITEM_PRICE("I_E_UAV_06_medical_backpack_F"), "vehicle", "SKIPSAVE"],
	...
	["AH-9 Pawnee", "B_Heli_Light_01_dynamicLoadout_F", 20000, "vehicle", "variant_pawneeNormal"], // Armed AH-6
	["PO-30 Orca (DAR)", "O_Heli_Light_02_dynamicLoadout_F", 30000, "vehicle", "variant_orcaDAR"], // Armed Ka-60
	["PO-30 Orca (DAGR)", "O_Heli_Light_02_dynamicLoadout_F", 38000, "vehicle", "variant_orcaDAGR"], // Armed Ka-60, add "HIDDEN" if you don't want it, but don't remove the line!
	["WY-55 Hellcat (Armed)", "I_Heli_light_03_dynamicLoadout_F", 40000, "vehicle"], // Armed AW159
	["AH-99 Blackfoot", "B_Heli_Attack_01_dynamicLoadout_F", 47500, "vehicle"], // RAH-66 with gunner
	["AH-99 Blackfoot AT (Extra Tough)", "B_Heli_Attack_01_dynamicLoadout_F", 80000, "vehicle", "variant_toughAT"],
...
[
	...
	["Y-32 Xi'an (Infantry)", "O_T_VTOL_02_infantry_dynamicLoadout_F", 15000, "vehicle"],
	["Y-32 Xi'an (Vehicle)", "O_T_VTOL_02_vehicle_dynamicLoadout_F", 20000, "vehicle"],

	["KH-3A Fenghuang Missile UAV", "O_T_UAV_04_CAS_F", 55000, "vehicle"],

	["MQ4A Greyhawk (Unarmed)", "B_UAV_02_dynamicLoadout_F", 15000, "vehicle", "variant_greyhawkUnarmed"],
	["K40 Ababil-3 (Unarmed)", "O_UAV_02_dynamicLoadout_F", 15000, "vehicle", "variant_greyhawkUnarmed"],
	["K40 Ababil-3 (Unarmed)", "I_UAV_02_dynamicLoadout_F", 15000, "vehicle", "variant_greyhawkUnarmed"],

	["MQ4A Greyhawk Cluster UAV", "B_UAV_02_dynamicLoadout_F", 23000, "vehicle", "variant_greyhawkCluster"],
	["K40 Ababil-3 Cluster UAV", "O_UAV_02_dynamicLoadout_F", 23000, "vehicle", "variant_greyhawkCluster"],
	["K40 Ababil-3 Cluster UAV", "I_UAV_02_dynamicLoadout_F", 23000, "vehicle", "variant_greyhawkCluster"],

	["MQ4A Greyhawk Bomber UAV", "B_UAV_02_dynamicLoadout_F", 28000, "vehicle", "variant_greyhawkBomber"], // Bomber UAVs are a lot harder to use, hence why they are cheaper than Missile ones
	["K40 Ababil-3 Bomber UAV", "O_UAV_02_dynamicLoadout_F", 28000, "vehicle", "variant_greyhawkBomber"],
	["K40 Ababil-3 Bomber UAV", "I_UAV_02_dynamicLoadout_F", 28000, "vehicle", "variant_greyhawkBomber"],

	["MQ4A Greyhawk DAGR UAV", "B_UAV_02_dynamicLoadout_F", 35000, "vehicle", "variant_greyhawkDAGR"],
	["K40 Ababil-3 DAGR UAV", "O_UAV_02_dynamicLoadout_F", 35000, "vehicle", "variant_greyhawkDAGR"],
	["K40 Ababil-3 DAGR UAV", "I_UAV_02_dynamicLoadout_F", 35000, "vehicle", "variant_greyhawkDAGR"],

	["MQ4A Greyhawk Missile UAV", "B_UAV_02_dynamicLoadout_F", 42000, "vehicle", "variant_greyhawkMissile"],
	["K40 Ababil-3 Missile UAV", "O_UAV_02_dynamicLoadout_F", 42000, "vehicle", "variant_greyhawkMissile"],
	["K40 Ababil-3 Missile UAV", "I_UAV_02_dynamicLoadout_F", 42000, "vehicle", "variant_greyhawkMissile"],

	["UCAV Sentinel Missile", "B_UAV_05_F", 55000, "vehicle", "variant_sentinelMissile"],
	["UCAV Sentinel Bomber", "B_UAV_05_F", 40000, "vehicle", "variant_sentinelBomber"],
	["UCAV Sentinel Cluster", "B_UAV_05_F", 30000, "vehicle", "variant_sentinelCluster"]
];
...
[
	...
	["MIM-145 Defender", "B_SAM_System_03_F", 50000],
	["R-750 Cronus Radar", "O_Radar_System_02_F", 10000],
	["S-750 Rhea", "O_SAM_System_04_F", 50000]
];
...
[
	...
	["Speedboat HMG", "O_Boat_Armed_01_hmg_F", 4000, "boat"],
	["Speedboat Minigun", "B_Boat_Armed_01_minigun_F", 4000, "boat"],
...
[
	["Artillery Strike", "artillery", "", "client\icons\tablet.paa", 200000, 75000, "HIDDEN"],
	...
	["Defibrillator", "defibrillator", localize "STR_WL_ShopDescriptions_Defibrillator", "client\icons\defibrillator.paa", 10000, 3000],
	...
	["Strap-on Bomb", "straponbomb", localize "STR_WL_ShopDescriptions_strapBomb", "client\icons\straponbomb.paa", 2250, 1125],
