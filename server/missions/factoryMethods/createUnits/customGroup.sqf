...
_side = ["WEST","EAST","GUER"] call BIS_fnc_selectRandom;
_loadout = [];
...
switch (_side) do
{
	case "WEST":
	{
		_camo = ["MTP", "Tropic", "CTRGUrban", "CTRGArid", "CTRGTropic", "Woodland"] call BIS_fnc_selectRandom;
		switch (_camo) do
		{
			case "MTP":
			{
	...
	case "GUER":
	{
		_camo = ["Digital", "Geometric", "Guerilla"] call BIS_fnc_selectRandom;
		switch (_camo) do
		{
			case "Digital":
			{
