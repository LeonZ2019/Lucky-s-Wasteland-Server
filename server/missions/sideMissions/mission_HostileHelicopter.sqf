...
private ["_vehicleClass", "_vehicle", "_createVehicle", "_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_numWaypoints", "_box1", "_box2", "_pos", "_boxTypes", "_box1Type", "_box2Type", "_hint"];
