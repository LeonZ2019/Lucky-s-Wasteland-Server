...
[
	...
	["Box_IND_WpsSpecial_F", [-1.04126, 0.24707, 0], 286.415, { [_this, ["mission_USLaunchers","mission_RULaunchers","mission_USSpecial","mission_USRifles","mission_RURifles","mission_USMachineguns","mission_RUMachineguns","mission_Main_A3snipers","mission_RUSniper","mission_Explosive","mission_Gear","mission_Militia"] call BIS_fnc_selectRandom] call fn_refillbox }],
	...
	["Box_East_WpsSpecial_F", [0.470947, -0.591309, 0], 85.8074, { [_this, ["mission_USLaunchers","mission_RULaunchers","mission_USSpecial","mission_USRifles","mission_RURifles","mission_USMachineguns","mission_RUMachineguns","mission_Main_A3snipers","mission_RUSniper","mission_Explosive","mission_Gear","mission_Militia"] call BIS_fnc_selectRandom] call fn_refillbox }],
