...
createRandomBandits = [_path, "createUnits\createRandomBandits.sqf"] call mf_compile;
createRandomParatrooper = [_path, "createUnits\createRandomParatrooper.sqf"] call mf_compile;
createStoryMen = [_path, "createUnits\createStoryMen.sqf"] call mf_compile;
createHostage = [_path, "createUnits\createHostage.sqf"] call mf_compile;
