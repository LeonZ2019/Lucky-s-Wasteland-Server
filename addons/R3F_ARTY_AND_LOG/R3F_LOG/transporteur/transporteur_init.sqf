...
_transporteur addAction [("<img image='client\icons\r3f_install.paa' color='#06ef00'/> <t color='#06ef00'>" + STR_R3F_LOG_action_install + "</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\transporteur\install.sqf", nil, 15, false, true, "", "R3F_LOG_objet_addAction == _target && R3F_LOG_action_install_valid"];

_transporteur addAction [("<img image='client\icons\r3f_uninstall.paa' color='#ff0000'/> <t color='#ff0000'>" + STR_R3F_LOG_action_uninstall + "</t>"), "addons\R3F_ARTY_AND_LOG\R3F_LOG\transporteur\uninstall.sqf", nil, 15, false, true, "", "R3F_LOG_objet_addAction == _target && R3F_LOG_action_uninstall_valid"];