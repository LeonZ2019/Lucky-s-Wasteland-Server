...
_minTimeBetweenWeatherChangesMin = 2.5;
...
_rainIntervalRainProbability = 25; // overcast syncing fubar, do not enable rain
...
drn_fnc_DynamicWeather_SetWeatherLocal = {
	...
	if (_currentWeatherChange == "FOG") then {
		...
		_timeUntilCompletion setFog [0 max (_currentRain / 8), 0.0, 0]; // do not change fog decay/base otherwise the fog level will vary unpredictably
	};
};
